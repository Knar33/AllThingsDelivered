...
namespace AllThingsDelivered.Controllers
{
    public class ScrapeController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //loop through array of lat/long coordinates
            var cityString = string.Format("https://api.foursquare.com/v2/venues/search?client_id={0}&client_secret={1}&v=20170825&near={2}&limit=50&categoryId=4d4b7105d754a06374d81259&intent=browse",
